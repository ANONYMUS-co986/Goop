...
export const ROUTES: VerdeRoute[] = [
  ...
  { href: "/build", label: "The Build", batch: "B2", live: false, blurb: "Exploded ESP32 — every wire on camera.", ghost: "01" },
  { href: "/brain", label: "The Brain", batch: "B3", live: false, blurb: "The bug that nearly killed us: 17 calls → 2.", ghost: "02" },
  { href: "/doctor", label: "AI Doctor", batch: "B4", live: false, blurb: "Point, click — the leaf gets a diagnosis.", ghost: "03" },
