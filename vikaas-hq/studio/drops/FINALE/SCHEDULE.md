...
|----:|------|-------|------|---------------|
| 1 | Thu 6 Aug | **V2 — 15 Recyclers, 0 Doorsteps** | REEL | Launch with the data bomb + NEW phonk. Sets the tone: receipts. |
| 2 | Fri 7 | **M1 — Drake's Choice** | meme | Relatable starter; the ₹40 hook travels. |
| 3 | Sat 8 | **P1 — It Takes One Drawer** | poster | Weekend art pause; saveable poster. |
| 4 | Sun 9 | **M7 — Dinner Debate** | meme | Sunday family-scroll prime time. The cat wins arguments. |
| 5 | Mon 10 | **V6 — THE MEME-REEL** | REEL | Show the whole arsenal in 26s; send people to the grid. |
| 6 | Tue 11 | **P5 — Original Supply Chain** | poster | Respect-the-kabadi day. Pair with a story: "spot your kabadiwala". |
| 7 | Wed 12 | **M2 — The Daily Struggle** | meme | Midweek relatability spike. |
| 8 | Thu 13 | **V1 — The Drawer** | REEL | Brand core. Week 2 opens with the origin story. |
| 9 | Fri 14 | **P2 — The ₹40 Handshake** | poster | Cash hook before weekend. |
| 10 | Sat 15 | **M4 — Side-Eye** | meme | Mummy content on Saturday = family shares. |
| 11 | Sun 16 | **V5 — Doorstep Phonk** | REEL | The transaction, phonked. Sunday energy. |
| 12 | Mon 17 | **P4 — Two Futures** | poster | Serious Monday. 2047 vision anchors credibility. |
| 13 | Tue 18 | **M5 — Kalm Panik Kalm** | meme | Data meme (3.2 Mt/yr) mid-run keeps sources alive. |
| 14 | Wed 19 | **P3 — 0.03 g of Gold** | poster | The wow-stat. 💰 comment bait: "check YOUR drawer". |
| 15 | Thu 20 | **V3 — Kabadi Paradox** | REEL | Week 3: the character play. |
| 16 | Fri 21 | **M6 — The Affair** | meme | Weekend shopping guilt-trip. Big Billion Days reference. |
...
- **After poster days:** poll sticker ("does YOUR house have a drawer?" yes/also yes).
- **Weekly:** one story tagging @1m1bfoundation with the week's reach total → M2 trail.

## Metrics to screenshot (24h after each post)
