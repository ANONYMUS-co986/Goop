...
ROUTES=("/" "/drawer" "/proof" "/kabadi" "/buddy" "/boot?fast=1" "/type" "/system" "/geneva")
...
echo "── 1. COMPILE ──"
for mod in /src/App.jsx /src/main.jsx /src/shell/Shell.jsx /src/components/Scape.jsx /src/components/AppPhone.jsx /src/pages/Gate.jsx /src/pages/Drawer.jsx /src/pages/Boot.jsx /src/pages/Type.jsx /src/pages/Proof.jsx /src/pages/Kabadi.jsx /src/pages/Assistant.jsx /src/pages/ComingSoon.jsx /src/lib/SafeNet.jsx; do
  code=$(curl -s -o /dev/null -w "%{http_code}" --max-time 10 "$BASE$mod")
  verdict "module $mod" "$([ "$code" = "200" ] && echo 0 || echo 1)" "HTTP $code"
done
for css in /src/assets/css/shell.css /src/assets/css/gate.css /src/assets/css/drawer.css /src/assets/css/boot.css /src/pages/type.css /src/pages/assistant.css /src/pages/proof.css /src/pages/kabadi.css /src/pages/comingsoon.css; do
