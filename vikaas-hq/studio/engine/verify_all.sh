...
ROUTES=("/" "/drawer" "/proof" "/boot?fast=1" "/type" "/app" "/app/book" "/app/centres" "/app/map" "/app/receipts" "/app/assistant" "/app/dashboard" "/app/login" "/app/admin")
...
for css in /src/assets/css/shell.css /src/assets/css/gate.css /src/assets/css/drawer.css /src/assets/css/boot.css /src/pages/type.css /src/pages/apphome.css /src/pages/book.css /src/pages/centres.css /src/pages/map.css /src/pages/receipts.css /src/pages/assistant.css /src/pages/op.css /src/pages/proof.css /src/pages/comingsoon.css; do
